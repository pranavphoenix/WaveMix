...
class Waveblock(nn.Module):
    ...
    def forward(self, x):
        ...
        xf1 = DWTForward(J=1, mode='zero', wave='db1').cuda() #Can be defined outside the function when using single GPU to increase speed
...
class WaveMix(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.segment = nn.Sequential(   #This is the only change from the Image Classification code
        ...
        self.conv = nn.Sequential(
            nn.Conv2d(3, int(final_dim/2), 3, 2, 1),   # Increase stride while using high resolution models depending on the GPU resources available
